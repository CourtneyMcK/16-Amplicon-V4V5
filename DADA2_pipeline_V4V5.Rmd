...
#then, we can take the relative abundance, will do for all samples
#this will only plot the top 20/30 phyla; any other phyla not in the top 20/30 will be put in other
```{r}
...
#then, we can take the relative abundance, will do for all samples
#this will only plot the top 20/30 families; any other families not in the top 20/30 will be put in other
```{r}
...
#then, we can take the relative abundance, will do for all samples
#this will only plot the top 20/30 genera; any other genera not in the top 20/30 will be put in other
```{r}
